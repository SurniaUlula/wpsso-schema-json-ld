<h1>Schema JSON-LD Markup | Google Rich Results / Rich Snippets with Structured Data</h1><h3>WPSSO Add-on</h3>
...
<tr><th align="right" valign="top" nowrap>Stable Version</th><td>2.25.0</td></tr>
...
<p><strong>Uses your existing WordPress content and plugin / API data for accurate and comprehensive Schema JSON-LD markup:</strong></p>

<p>Including image SEO, video SEO, local business, organization, publisher, person, author and co-authors, extensive e-Commerce product markup, product variations, product ratings, aggregate ratings, reviews, recipe information, event details, collection pages, profile pages, search pages, FAQ pages, item lists for <a href="https://developers.google.com/search/docs/guides/mark-up-listings">Google's Carousel Rich Results</a>, and much, much more (see below for Standard and Premium version details).</p>
...
<p>The Standard and Premium versions both fix all Google testing tool errors for their supported Schema types:</p>
...
<li><p>Provides Schema properties as JSON-LD markup (aka Google Rich Results / Rich Snippets with Structured Data) for the following Schema types, including Schema ItemList for <a href="https://developers.google.com/search/docs/guides/mark-up-listings">Google's Carousel Rich Results</a> (more specific Schema type properties are available in the Premium version):</p>

<ul>
<li><a href="https://schema.org/Article">schema.org/Article</a> (includes 19 sub-types)</li>
<li><a href="https://schema.org/Blog">schema.org/Blog</a></li>
<li><a href="https://schema.org/CreativeWork">schema.org/CreativeWork</a> (includes 86 sub-types)</li>
<li><a href="https://schema.org/ItemList">schema.org/ItemList</a> (includes 5 sub-types)</li>
<li><a href="https://schema.org/Thing">schema.org/Thing</a> (includes 1457 sub-types)</li>
</ul></li>
...
<li>Product Depth Attribute Name </li>
...
<li>Product Depth Custom Field (cm)</li>
...
<li>Product Height Custom Field </li>
<li>Product ISBN Custom Field </li>
<li>Product Length Custom Field (cm)</li>
...
<li>Product Volume Custom Field (ml)</li>
<li>Product Weight Custom Field (kg)</li>
<li>Product Width Custom Field (cm)</li>
...
<ul>
<li><p>Provides Schema properties as JSON-LD markup (aka Google Rich Results / Rich Snippets with Structured Data) for the following Schema types:</p>
...
<li><a href="https://schema.org/CollectionPage">schema.org/CollectionPage</a> (includes 3 sub-types)</li>
<li><a href="https://schema.org/Course">schema.org/Course</a></li>
<li><a href="https://schema.org/CreativeWork">schema.org/CreativeWork</a> (includes 86 sub-types)</li>
<li><a href="https://schema.org/Event">schema.org/Event</a> (includes 19 sub-types)</li>
<li><a href="https://schema.org/FAQPage">schema.org/FAQPage</a></li>
<li><a href="https://schema.org/FoodEstablishment">schema.org/FoodEstablishment</a> (includes 17 sub-types)</li>
<li><a href="https://schema.org/HowTo">schema.org/HowTo</a> (includes 2 sub-types)</li>
<li><a href="https://schema.org/JobPosting">schema.org/JobPosting</a></li>
<li><a href="https://schema.org/LocalBusiness">schema.org/LocalBusiness</a> (includes 479 sub-types)</li>
<li><a href="https://schema.org/Movie">schema.org/Movie</a></li>
<li><a href="https://schema.org/Organization">schema.org/Organization</a> (includes 502 sub-types)</li>
<li><a href="https://schema.org/Person">schema.org/Person</a></li>
<li><a href="https://schema.org/Place">schema.org/Place</a> (includes 529 sub-types)</li>
<li><a href="https://schema.org/Product">schema.org/Product</a> (includes 9 sub-types)</li>
...
<li><a href="https://schema.org/Review">schema.org/Review</a> (includes 2 sub-types)</li>
<li><a href="https://schema.org/SearchResultsPage">schema.org/SearchResultsPage</a></li>
<li><a href="https://schema.org/SoftwareApplication">schema.org/SoftwareApplication</a> (includes 4 sub-types)</li>
<li><a href="https://schema.org/Thing">schema.org/Thing</a> (includes 1457 sub-types)</li>
<li><a href="https://schema.org/WebPage">schema.org/WebPage</a> (includes 13 sub-types)</li>
<li><a href="https://schema.org/WebSite">schema.org/WebSite</a></li>
</ul></li>
<li><p>Provides Schema FAQPage and Question / Answer markup for the <a href="https://wordpress.org/plugins/wpsso-faq/">WPSSO FAQ Manager</a> add-on custom post types, taxonomies and shortcodes.</p></li>
...
<li>Schema Type <a href="https://schema.org/FinancialProduct">schema.org/FinancialProduct</a>

<ul>
<li>Schema Type <a href="https://schema.org/BankAccount">schema.org/BankAccount</a>

<ul>
<li>Schema Type <a href="https://schema.org/DepositAccount">schema.org/DepositAccount</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/CurrencyConversionService">schema.org/CurrencyConversionService</a></li>
<li>Schema Type <a href="https://schema.org/InvestmentOrDeposit">schema.org/InvestmentOrDeposit</a>

<ul>
<li>Schema Type <a href="https://schema.org/BrokerageAccount">schema.org/BrokerageAccount</a></li>
<li>Schema Type <a href="https://schema.org/DepositAccount">schema.org/DepositAccount</a></li>
<li>Schema Type <a href="https://schema.org/InvestmentFund">schema.org/InvestmentFund</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/LoanOrCredit">schema.org/LoanOrCredit</a>

<ul>
<li>Schema Type <a href="https://schema.org/CreditCard">schema.org/CreditCard</a></li>
<li>Schema Type <a href="https://schema.org/MortgageLoan">schema.org/MortgageLoan</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/PaymentCard">schema.org/PaymentCard</a>

<ul>
<li>Schema Type <a href="https://schema.org/CreditCard">schema.org/CreditCard</a></li>
</ul></li>
<li>Schema Type <a href="https://schema.org/PaymentService">schema.org/PaymentService</a></li>
</ul></li>
...
<li>Schema Type <a href="https://schema.org/MovieTheater">schema.org/MovieTheater</a></li>
...
<li><p><a href="http://wpsso.com/docs/plugins/wpsso-schema-json-ld/notes/markup-examples/markup-example-for-a-woocommerce-product/">Markup Example for a WooCommerce Product</a>, including its name, description, images, brand, sku, price, availability, category, width, height, weight, variations, and much more.</p></li>
<li><p><a href="http://wpsso.com/docs/plugins/wpsso-schema-json-ld/notes/markup-examples/markup-example-for-a-wp-ecommerce-product/">Markup Example for a WP eCommerce Product</a>, including its name, description, images, brand, sku, price, availability, category, width, height, weight, variations, and much more.</p></li>
</ul>
