...
<p>The WPSSO Schema JSON-LD Markup add-on provides Google Rich Results with Structured Data for Articles, Carousels (aka ItemList), Events, FAQPages, HowTos, Images, Local Business, Products, Recipes, Reviews, Videos, and more.</p>
