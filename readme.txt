...
Provides Schema Product markup for [Google price drop appearance in search results](https://developers.google.com/search/docs/data-types/product#price-drop).
...
(2021/01/21) Added support for images in each element of the review property.

= 4.12.0 =

(2020/12/11) Removed deprecated `$posts_per_page` method arguments and constants.
...
(2020/11/26) Moved all SSO &gt; Schema Markup &gt; Schema Defaults tab options to a new Schema Defaults metabox.

= 4.9.0 =

(2020/11/20) Renamed the 'plugin_def_currency' options key to 'og_def_currency' for WPSSO Core v8.13.0.

= 4.8.0 =

(2020/11/13) Added a check to skip loading Schema filter hooks if Schema markup is disabled.
