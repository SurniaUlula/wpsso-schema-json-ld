...
_x( 'Reviewed Item Information', 'metabox title', 'wpsso-schema-json-ld' );
_x( 'Item Type', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item URL', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Same-As URLs', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Name', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Description', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Image ID', 'option label', 'wpsso-schema-json-ld' );
_x( 'or an Image URL', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Author Type', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Author Name', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Author URL', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Published Date', 'option label', 'wpsso-schema-json-ld' );
_x( 'Item Created Date', 'option label', 'wpsso-schema-json-ld' );
