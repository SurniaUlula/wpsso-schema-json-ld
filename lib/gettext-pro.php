...
_x( 'Reviewed Creative Work Information', 'metabox title', 'wpsso-schema-json-ld' );
_x( 'Reviewed CW Author Type', 'option label', 'wpsso-schema-json-ld' );
_x( 'Reviewed CW Author Name', 'option label', 'wpsso-schema-json-ld' );
_x( 'Reviewed CW Author URL', 'option label', 'wpsso-schema-json-ld' );
_x( 'Reviewed CW Publish Date', 'option label', 'wpsso-schema-json-ld' );
