...
_x( 'CW Author Type', 'option label', 'wpsso-schema-json-ld' );
_x( 'CW Author Name', 'option label', 'wpsso-schema-json-ld' );
_x( 'CW Author URL', 'option label', 'wpsso-schema-json-ld' );
_x( 'CW Published Date', 'option label', 'wpsso-schema-json-ld' );
_x( 'CW Created Date', 'option label', 'wpsso-schema-json-ld' );
